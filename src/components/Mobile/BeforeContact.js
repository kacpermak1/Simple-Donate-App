    ...
    render() {
        ...
        return (
            <section className="beforeContact">
                {session? <p>Do you want to get rid of <br/> unwanted items and do something <br/> good for others?</p> : <p>Would you like to donate your<br /> unwanted items to charity or <br /> organize a local collection?</p>}
